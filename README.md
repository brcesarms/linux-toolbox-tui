...
* 🚚 **[Migração GEEKOM → Alienware (Guia Passo a Passo)](./runbooks/migracao-geekom-alienware.md)** — procedimento manual detalhado para migrar cofre, RAG, notas e configs mantendo o host de origem intacto.
